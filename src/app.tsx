  ...
  return (
    <div className="flex flex-col justify-center min-h-screen py-6 bg-gray-100 sm:py-12">
      <div className="relative py-3 sm:max-w-xl sm:mx-auto">
        <div className="absolute inset-0 transform -skew-y-6 shadow-lg bg-gradient-to-r from-cyan-400 to-lightBlue-500 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl" />
        <div className="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
          <div className="max-w-md mx-auto">
            <div>
              <img className="h-7 sm:h-8" src="https://play.tailwindcss.com/img/logo.svg" />
            </div>
            <div className="divide-y divide-gray-200">
              ...
              <div className="pt-6 text-base font-bold leading-6 sm:text-lg sm:leading-7">
                ...
                <p>
                  <a className="text-cyan-600 hover:text-cyan-700" href="https://tailwindcss.com/docs"> Read the docs &rarr; </a>
                </p>
              </div>
            </div>
          </div>
